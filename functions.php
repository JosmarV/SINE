<?php
	...
	function lideres(){
		...
		$sql = "SELECT *, BLOQUE.NUMERO_BLOQUE AS NRO_BLOQUE FROM LIDER JOIN BLOQUE ON (LIDER.ID_BLOQUE = BLOQUE.ID) ORDER BY NRO_BLOQUE";
	...
	function brigadistas(){
		...
		$sql = "SELECT *, BLOQUE.NUMERO_BLOQUE AS NRO_BLOQUE FROM BRIGADISTA JOIN BLOQUE ON (BRIGADISTA.ID_BLOQUE = BLOQUE.ID) ORDER BY NRO_BLOQUE";
